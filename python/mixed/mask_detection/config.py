...
DETECT_MODEL_FILE=os.path.join(PREDICT_FILE_PATH, "models/pyramidbox_lite/model")
# face detect params file dir
DETECT_MODEL_PARAM=os.path.join(PREDICT_FILE_PATH,"models/pyramidbox_lite/params")
...
MASK_MODEL_PARAM=os.path.join(PREDICT_FILE_PATH,"models/mask_detector/params")
