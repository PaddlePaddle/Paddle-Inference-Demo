...
class RelationExtractionMultiCLSReader(BaseReader):
    ...
    def _convert_example_to_record(self, example_index, example,
        ...
        for spo in spo_list:
            for spo_object in spo['object'].keys():
                ...
                if spo['predicate'] in self.label_map.keys():
                    ...
                    object_sub_tokens = tokenizer.tokenize(
                        spo['object']['@value'])
                else:
                    # complex relation
                ...
                if len(subject_sub_tokens) > len(object_sub_tokens):
                    for index in range(
                        ...
                        if tokens[index:index + len(subject_sub_tokens
                                                    )] == subject_sub_tokens:
                    ...
                    for index in range(
                        ...
                        if tokens[index:index +
                                  len(object_sub_tokens)] == object_sub_tokens:
