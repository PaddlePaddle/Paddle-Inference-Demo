...
请参考[下载安装 Windows 推理库](https://www.paddlepaddle.org.cn/inference/guides/install/download_lib.html#windows)下载 C++ 推理库。
...
请从[下载安装 Ubuntu 推理库](https://www.paddlepaddle.org.cn/inference/guides/install/download_lib.html#linux)下载 Python whl 包并安装，名称中带有 `cuda` 的为用于 GPU 的推理库。
