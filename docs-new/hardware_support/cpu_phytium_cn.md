...
**环境准备：** 请根据[编译依赖表](https://www.paddlepaddle.org.cn/documentation/docs/zh/develop/install/Tables.html)准备符合版本要求的依赖库，推荐使用飞桨官方镜像，否则请参考[麒麟技术文档](https://eco.kylinos.cn/document/science.html)或[统信生态社区](https://doc.chinauos.com/)。
