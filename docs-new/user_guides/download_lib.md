...
|硬件后端|是否打开avx|数学库|gcc版本|CUDA/cuDNN/TensorRT版本|预测库(2.3.0版本)|
|--------------|--------------|--------------|--------------|--------------|:-----------------|
...
| 硬件后端 | 是否使用avx |     编译器     |  CUDA/cuDNN/TensorRT版本  | 数学库  |预测库(2.3.0版本)   |
|--------------|--------------|:----------------|:--------|:-------------|:-----------------|
...
| 硬件后端 |是否打开avx | 数学库  |     编译器版本     | CUDA/cuDNN/TensorRT版本  |预测库(2.3.0版本)   |
|----------|:--------|:---------|:--------------|:---------|:-----------------|
