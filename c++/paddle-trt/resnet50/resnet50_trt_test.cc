...
DEFINE_string(model_file, "", "File of the inference model.");
DEFINE_string(params_file, "", "File of the inference model.");
...
std::unique_ptr<paddle::PaddlePredictor> CreatePredictor() {
  ...
  // Enable TensorRT
  config.EnableTensorRtEngine(1 << 30, FLAGS_batch_size, 3, AnalysisConfig::Precision::kFloat32, false, false);
