...
ResNet50 样例展示了在 GPU 下进行混合精度推理的过程。运行步骤如下：
...
```shell
./build/resnet50_test --model_file resnet50/inference.pdmodel --params_file resnet50/inference.pdiparams --use_gpu_fp16=1
```
