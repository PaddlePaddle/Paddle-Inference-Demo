...
int main(int argc, char *argv[]) {
  ...
  cudaMallocManaged((void**)&input_data, sizeof(float) * input_data_size);
  cudaMallocManaged((void**)&out_data, sizeof(float) * out_data_size);
  ...
  cudaFree((void**)&input_data);
  cudaFree((void**)&out_data);
  return 0;
}
